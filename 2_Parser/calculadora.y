...
DECLARACAO_VAR : 
    |DECLARACAO_VAR IDENTIFICACAO_VAR DOISPT TIPO_VAR EOL
	| IDENTIFICACAO_VAR DOISPT TIPO_VAR EOL
	;	
...
TIPO_VAR : VETOR COCHETEESQ NUM_INT PTPT NUM_INT COCHETEDIR DE TIPO_VAR
    | INT
	| REAL
	| CARACTERE
	| LOGICO
...
FUNCOES : FUNC ID PARAMETROS DOISPT TIPO_VAR EOL TUDO_COMP FIMFUNC EOL
	| PROC ID PARAMETROS EOL TUDO_COMP FIMPROC EOL
	;

PARAMETROS : 
	| PARENESQ PARAMETROS_FUNC PARENDIR
	;

PARAMETROS_FUNC : 
	| IDENTIFICACAO_VAR DOISPT TIPO_VAR VIRGULA IDENTIFICACAO_VAR DOISPT TIPO_VAR
	| IDENTIFICACAO_VAR DOISPT TIPO_VAR
	;
...
CHAMADA_FUNC : ID PARENESQ CHAMADA_FUNC_2 PARENDIR
	;
...
FUNCOES_IO : ALEATORIO PARENESQ TODAS_EXPRESSOES VIRGULA TODAS_EXPRESSOES PARENDIR
	| LEIA PARENESQ TODAS_EXPRESSOES PARENDIR
	| ESCREVA PARENESQ TODAS_EXPRESSOES VIRGULA TODAS_EXPRESSOES PARENDIR
	;
...
EXPRESSOES_COMP : TODAS_EXPRESSOES
	...
	| EXPRESSOES_COMP MENORIG TODAS_EXPRESSOES
	| EXPRESSOES_COMP MAIORIG TODAS_EXPRESSOES
	| EXPRESSOES_COMP DIF TODAS_EXPRESSOES
	;

BASE_EXPRESSOES : PARENESQ BASE_EXPRESSOES PARENDIR
	| EXPRESSOES_COMP
